...
from v8.repair_facilities as facility
         join v8.lodgers as lodger on lodger.id = facility.lodger_id
         join v8.repairments as repairment on repairment.id = facility.repairment_id
         join v8.repairers as repairer on repairer.id = repairment.repairer_id
         join v8.cities as city on city.id = repairer.city_id;
